...
| 2025-08-09 | 1.0.1   | Re-validate lint/type-check/build: PASS (no code changes) | James |
...
2025-08-09: Re-validated with `npm ci`, `npm run lint`, `npm run build` in `web` → PASS (Next.js 15.4.6). Không thay đổi mã nguồn.
