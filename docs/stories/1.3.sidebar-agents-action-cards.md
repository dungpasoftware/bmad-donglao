...
- [x] Sidebar (Left) hiển thị danh sách agents (AC: 1, 3)
...
- [x] Header hiển thị thông tin agent đã chọn (AC: 1)
...
- [x] Action Cards (placeholder) map tới command id (AC: 2)
...
- [x] Điều hướng chi tiết agent (AC: 3)
...
| 2025-08-09 | 0.5     | Set Status → Done                                 | Sarah  |
...
- Impl notes
 ...
 - Post-merge: main `9e0ca39` — lint/tsc/build PASS
